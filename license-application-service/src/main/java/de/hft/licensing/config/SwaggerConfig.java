                                ...
                                new SecurityScheme()
                                        ...
                                        .flows(new OAuthFlows()
                                                .authorizationCode(new OAuthFlow()
                                                        .authorizationUrl("http://localhost:8081/realms/license-realm/protocol/openid-connect/auth")
                                                        .tokenUrl("http://localhost:8081/realms/license-realm/protocol/openid-connect/token")
                                                        .scopes(new Scopes()
