...
export default function AdminApplicationDetails({
  ...
  useQueryClient();
  const [licenseReleased] = useState(false);

  if (!open || !applicationData || !userId) {
    return null;
  }

  const licenseData = useGetLicenseData(
      licenseReleased ? undefined : userId,
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div
            ...
            <div className="font-inter text-center">
              <div className="font-inter min-w-80vb max-w-200vb mb-12">
                <FormHeader
                ...
                <div className="bg-gray-50 rounded-lg p-6 mt-2 shadow space-y-2.5 text-gray-700">
                  ...
                  <div className="flex justify-between min-w-lg">
                  <span>
                    {t("applicationDetails.index.user.idLabel") + ": "}
                  </span>
                    <span>{userId}</span>
                  </div>
                </div>
