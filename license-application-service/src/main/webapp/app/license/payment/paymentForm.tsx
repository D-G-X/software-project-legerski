...
import {isValidBic, isValidIban, isValidName,} from "../../common/validationRules";
import {useTranslation} from "react-i18next";
import {useDocumentTitle} from "app/common/utils";
import {FormHeader} from "app/common/headingTitle";
import {useCreatePayment, useGetApplicationFee,} from "app/services/payments/payments";
import {useGetApplication, useUpdateApplication} from "app/services/applications/applications";
import {ApplicationStatusApiEnum} from "types/applicationStatusApiEnum";
import ModalDialog from "../../common/modal-dialog";
import {useNavigate, useParams} from "react-router";
import {formatAmount, formatBic, formatDateLong, formatIban,} from "../../common/utils";
                  ...
                  <span className="leading-none">
                    {isFetchingAppData || isFetchingAppFee ? (
                        <div className="w-32 h-6 rounded-md overflow-hidden relative">
                          <div
                              className="absolute inset-0 bg-linear-to-r from-gray-200 via-mallorca-purple/30 to-gray-200 animate-shimmer"/>
                        </div>
                    ) : (
