...
export default function ApplicationDocumentUpload() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("http://10.10.10.1:8080/process-document", {
        method: "POST",
        body: formData,
      });
        ...
        <div className="flex justify-center my-8">
          <div className="mb-4 w-full lg:w-[75%] xl:w-[50%]">
            ...
            <div className="mt-4">
              ...
              <label
                  className="block md:flex items-center justify-between shadow-sm cursor-pointer transition p-2 bg-mallorca-purple/10 hover:bg-mallorca-purple/75 border-2 border-mallorca-purple rounded-2xl text-mallorca-purple hover:text-white">
